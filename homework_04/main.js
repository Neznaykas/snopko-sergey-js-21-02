...
function dz3() { //12/02/2021 12-00
    let text = prompt("Введите строку с датой формата: '12/02/2021 12-00'", '12/02/2021 12-00').trim();
...
function dz6() {
    const text = prompt("Введите HTML c с комментариями", "<!-- 123123 -->");
...
function dz8() {
    const regex = /^[a-zA-Z0-9]{4}((|-)[a-zA-Z0-9]{4}){3}$/;
    const text = prompt("Введите идентификатор документа", "AaAR-ffff-1234-QWER").trim();
